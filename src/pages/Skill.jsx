		...
		<div className="skill content">
			...
			<div className="main">
				<ul>
					...
					<li className="card" style={{ "--percentage": "85%" }}>
						...
						<div className="info">
							...
							<div className="description">
								<p className="study-duration">勉強歴：5ヶ月</p>
								<p>現在できること：</p>
					...
					<li className="card" style={{ "--percentage": "70%" }}>
						...
						<div className="info">
							...
							<div className="description">
								<p className="study-duration">勉強歴：2ヶ月</p>
					...
					<li className="card" style={{ "--percentage": "90%" }}>
						<div className="card-shown">
					...
					<li className="card" style={{ "--percentage": "85%" }}>
						...
						<div className="info">
							...
							<span className="accent-color bar"></span>
							<div className="description">
								<p className="study-duration">勉強歴：4ヶ月</p>
					...
					<li className="card" style={{ "--percentage": "75%" }}>
						<div className="card-shown">
							Next.js<span className="accent-color bar"></span>
						</div>
						<div className="info">
							<p> Next.js</p>
							<span className="accent-color bar"></span>
							<div className="description">
								...
								<p className="sentence">
									動的、静的なSPAサイトの作成
									<br />
									Framer Motionを取り入れたアニメーションの作成
									<br />
									Chakra-UIを取り入れた短期間のウェブ制作
								</p>
							</div>
						</div>
					</li>
